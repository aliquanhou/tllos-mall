          ...
          <div class="order-body">
            ...
            <div class="order-actions">
              ...
              <div class="action-buttons">
                ...
                <el-button size="small" v-if="order.status == 0" @click="cancelOrderAction(order)">取消订单</el-button>
...
const fetchOrders = async () => {
  try {
    ...
    orders.value = res.data?.list || res.data?.data || res.data || []
...
const applyAfterSale = (order) => { router.push('/after-sale') }
const reviewOrder = (order) => { router.push('/review') }
