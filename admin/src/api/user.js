...
export function getUserDetail(id) { return request({ url: `/admin/users/${id}`, method: 'get' }) }
export function updateUser(id, data) { return request({ url: `/admin/users/${id}`, method: 'put', data }) }
export function toggleUserStatus(id, data) { return request({ url: `/admin/users/${id}/toggle-status`, method: 'post', data }) }
