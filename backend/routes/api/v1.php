...
// 用户端内容（文章、公告、热门搜索）
Route::middleware(\App\Http\Middleware\ApiCache::class)->prefix('articles')->group(function () {
    Route::get('/', [\App\Modules\Application\Controllers\ApplicationController::class, 'userArticles']);
    Route::get('/categories', [\App\Modules\Application\Controllers\ApplicationController::class, 'userArticleCategories']);
    Route::get('/{id}', [\App\Modules\Application\Controllers\ApplicationController::class, 'userArticleDetail']);
});

Route::middleware(\App\Http\Middleware\ApiCache::class)->prefix('notices')->group(function () {
    Route::get('/', [\App\Modules\Application\Controllers\ApplicationController::class, 'userNotices']);
    Route::get('/{id}', [\App\Modules\Application\Controllers\ApplicationController::class, 'userNoticeDetail']);
});

Route::middleware(\App\Http\Middleware\ApiCache::class)->get('hot-search', [\App\Modules\Application\Controllers\ApplicationController::class, 'hotSearchKeywords']);

// 用户端商品分类（公开）
Route::middleware(\App\Http\Middleware\ApiCache::class)->prefix('categories')->group(function () {
...
// 用户端品牌（公开）
Route::middleware(\App\Http\Middleware\ApiCache::class)->prefix('brands')->group(function () {
    Route::get('/', [\App\Modules\Product\Controllers\BrandController::class, 'index']);
    Route::get('/all', [\App\Modules\Product\Controllers\BrandController::class, 'all']);
});

// 用户端商品评价（公开）
Route::middleware(\App\Http\Middleware\ApiCache::class)->prefix('comments')->group(function () {
    Route::get('/product', [\App\Modules\Product\Controllers\CommentController::class, 'productList']);
});

// 用户端评价（需登录）
Route::middleware('auth:sanctum')->prefix('comments')->group(function () {
    Route::post('/', [\App\Modules\Product\Controllers\CommentController::class, 'store']);
    Route::get('/my', [\App\Modules\Product\Controllers\CommentController::class, 'myList']);
});
...
Route::middleware(\App\Http\Middleware\ApiCache::class)->get('home', [\App\Modules\Home\Controllers\HomeController::class, 'index']);
...
Route::middleware(\App\Http\Middleware\ApiCache::class)->prefix('products')->group(function () {
