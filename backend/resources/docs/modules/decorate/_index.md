...
| 方法 | 路径 | 控制器方法 | 说明 | 权限标识 |
|------|------|-----------|------|----------|
| GET | /api/v1/admin/decorate/_index | DecorateController@index | 装修管理总览列表 | decorate:list |
| POST | /api/v1/admin/decorate/_index | DecorateController@store | 新增装修管理总览 | decorate:create |
| GET | /api/v1/admin/decorate/_index/{id} | DecorateController@show | 装修管理总览详情 | decorate:view |
| PUT | /api/v1/admin/decorate/_index/{id} | DecorateController@update | 编辑装修管理总览 | decorate:edit |
| DELETE | /api/v1/admin/decorate/_index/{id} | DecorateController@destroy | 删除装修管理总览 | decorate:delete |
