...
| 方法 | 路径 | 控制器方法 | 说明 | 权限标识 |
|------|------|-----------|------|----------|
| GET | /api/v1/admin/decorate/templates | DecorateController@index | 模板管理列表 | decorate:list |
| POST | /api/v1/admin/decorate/templates | DecorateController@store | 新增模板管理 | decorate:create |
| GET | /api/v1/admin/decorate/templates/{id} | DecorateController@show | 模板管理详情 | decorate:view |
| PUT | /api/v1/admin/decorate/templates/{id} | DecorateController@update | 编辑模板管理 | decorate:edit |
| DELETE | /api/v1/admin/decorate/templates/{id} | DecorateController@destroy | 删除模板管理 | decorate:delete |
