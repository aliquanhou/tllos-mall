...
| 方法 | 路径 | 控制器方法 | 说明 | 权限标识 |
|------|------|-----------|------|----------|
| GET | /api/v1/admin/decorate/banner | DecorateController@index | 轮播图列表 | decorate:list |
| POST | /api/v1/admin/decorate/banner | DecorateController@store | 新增轮播图 | decorate:create |
| GET | /api/v1/admin/decorate/banner/{id} | DecorateController@show | 轮播图详情 | decorate:view |
| PUT | /api/v1/admin/decorate/banner/{id} | DecorateController@update | 编辑轮播图 | decorate:edit |
| DELETE | /api/v1/admin/decorate/banner/{id} | DecorateController@destroy | 删除轮播图 | decorate:delete |
