...
| 方法 | 路径 | 控制器方法 | 说明 | 权限标识 |
|------|------|-----------|------|----------|
| GET | /api/v1/admin/decorate/navigations | DecorateController@index | 导航图标列表 | decorate:list |
| POST | /api/v1/admin/decorate/navigations | DecorateController@store | 新增导航图标 | decorate:create |
| GET | /api/v1/admin/decorate/navigations/{id} | DecorateController@show | 导航图标详情 | decorate:view |
| PUT | /api/v1/admin/decorate/navigations/{id} | DecorateController@update | 编辑导航图标 | decorate:edit |
| DELETE | /api/v1/admin/decorate/navigations/{id} | DecorateController@destroy | 删除导航图标 | decorate:delete |
...
| 更新时间 | decorate.updated_at | 直接读取 | 实时 |
