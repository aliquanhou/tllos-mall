...
| 方法 | 路径 | 控制器方法 | 说明 | 权限标识 |
|------|------|-----------|------|----------|
| GET | /api/v1/admin/distribute/settings | DistributeController@index | 分销设置列表 | distribute:list |
| POST | /api/v1/admin/distribute/settings | DistributeController@store | 新增分销设置 | distribute:create |
| GET | /api/v1/admin/distribute/settings/{id} | DistributeController@show | 分销设置详情 | distribute:view |
| PUT | /api/v1/admin/distribute/settings/{id} | DistributeController@update | 编辑分销设置 | distribute:edit |
| DELETE | /api/v1/admin/distribute/settings/{id} | DistributeController@destroy | 删除分销设置 | distribute:delete |
