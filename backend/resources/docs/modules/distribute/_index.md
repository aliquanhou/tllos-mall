...
| 方法 | 路径 | 控制器方法 | 说明 | 权限标识 |
|------|------|-----------|------|----------|
| GET | /api/v1/admin/distribute/_index | DistributeController@index | 分销管理总览列表 | distribute:list |
| POST | /api/v1/admin/distribute/_index | DistributeController@store | 新增分销管理总览 | distribute:create |
| GET | /api/v1/admin/distribute/_index/{id} | DistributeController@show | 分销管理总览详情 | distribute:view |
| PUT | /api/v1/admin/distribute/_index/{id} | DistributeController@update | 编辑分销管理总览 | distribute:edit |
| DELETE | /api/v1/admin/distribute/_index/{id} | DistributeController@destroy | 删除分销管理总览 | distribute:delete |
