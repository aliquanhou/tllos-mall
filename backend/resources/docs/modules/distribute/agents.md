...
| 方法 | 路径 | 控制器方法 | 说明 | 权限标识 |
|------|------|-----------|------|----------|
| GET | /api/v1/admin/distribute/agents | DistributeController@index | 分销商管理列表 | distribute:list |
| POST | /api/v1/admin/distribute/agents | DistributeController@store | 新增分销商管理 | distribute:create |
| GET | /api/v1/admin/distribute/agents/{id} | DistributeController@show | 分销商管理详情 | distribute:view |
| PUT | /api/v1/admin/distribute/agents/{id} | DistributeController@update | 编辑分销商管理 | distribute:edit |
| DELETE | /api/v1/admin/distribute/agents/{id} | DistributeController@destroy | 删除分销商管理 | distribute:delete |
