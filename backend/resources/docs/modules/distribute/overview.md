...
| 方法 | 路径 | 控制器方法 | 说明 | 权限标识 |
|------|------|-----------|------|----------|
| GET | /api/v1/admin/distribute/overview | DistributeController@index | 分销概览列表 | distribute:list |
| POST | /api/v1/admin/distribute/overview | DistributeController@store | 新增分销概览 | distribute:create |
| GET | /api/v1/admin/distribute/overview/{id} | DistributeController@show | 分销概览详情 | distribute:view |
| PUT | /api/v1/admin/distribute/overview/{id} | DistributeController@update | 编辑分销概览 | distribute:edit |
| DELETE | /api/v1/admin/distribute/overview/{id} | DistributeController@destroy | 删除分销概览 | distribute:delete |
