...
| 方法 | 路径 | 控制器方法 | 说明 | 权限标识 |
|------|------|-----------|------|----------|
| GET | /api/v1/admin/user/_index | UserController@index | 用户管理总览列表 | user:list |
| POST | /api/v1/admin/user/_index | UserController@store | 新增用户管理总览 | user:create |
| GET | /api/v1/admin/user/_index/{id} | UserController@show | 用户管理总览详情 | user:view |
| PUT | /api/v1/admin/user/_index/{id} | UserController@update | 编辑用户管理总览 | user:edit |
| DELETE | /api/v1/admin/user/_index/{id} | UserController@destroy | 删除用户管理总览 | user:delete |
...
| 操作 | 权限标识 | 默认角色 |
|------|----------|----------|
| 查看列表 | user:list | 管理员/运营 |
| 新增 | user:create | 管理员 |
| 编辑 | user:edit | 管理员 |
| 删除 | user:delete | 管理员 |
| 状态管理 | user:status | 管理员 |
