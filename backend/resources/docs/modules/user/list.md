...
| 方法 | 路径 | 控制器方法 | 说明 | 权限标识 |
|------|------|-----------|------|----------|
| GET | /api/v1/admin/user/list | UserController@index | 用户列表列表 | user:list |
| POST | /api/v1/admin/user/list | UserController@store | 新增用户列表 | user:create |
| GET | /api/v1/admin/user/list/{id} | UserController@show | 用户列表详情 | user:view |
| PUT | /api/v1/admin/user/list/{id} | UserController@update | 编辑用户列表 | user:edit |
| DELETE | /api/v1/admin/user/list/{id} | UserController@destroy | 删除用户列表 | user:delete |
