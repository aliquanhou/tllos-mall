...
| 方法 | 路径 | 控制器方法 | 说明 | 权限标识 |
|------|------|-----------|------|----------|
| GET | /api/v1/admin/product/brand | ProductController@index | 品牌管理列表 | product:list |
| POST | /api/v1/admin/product/brand | ProductController@store | 新增品牌管理 | product:create |
| GET | /api/v1/admin/product/brand/{id} | ProductController@show | 品牌管理详情 | product:view |
| PUT | /api/v1/admin/product/brand/{id} | ProductController@update | 编辑品牌管理 | product:edit |
| DELETE | /api/v1/admin/product/brand/{id} | ProductController@destroy | 删除品牌管理 | product:delete |
