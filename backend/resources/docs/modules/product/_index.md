...
| 方法 | 路径 | 控制器方法 | 说明 | 权限标识 |
|------|------|-----------|------|----------|
| GET | /api/v1/admin/product/_index | ProductController@index | 商品管理总览列表 | product:list |
| POST | /api/v1/admin/product/_index | ProductController@store | 新增商品管理总览 | product:create |
| GET | /api/v1/admin/product/_index/{id} | ProductController@show | 商品管理总览详情 | product:view |
| PUT | /api/v1/admin/product/_index/{id} | ProductController@update | 编辑商品管理总览 | product:edit |
| DELETE | /api/v1/admin/product/_index/{id} | ProductController@destroy | 删除商品管理总览 | product:delete |
