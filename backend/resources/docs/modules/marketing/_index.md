...
| 方法 | 路径 | 控制器方法 | 说明 | 权限标识 |
|------|------|-----------|------|----------|
| GET | /api/v1/admin/marketing/_index | MarketingController@index | 营销管理总览列表 | marketing:list |
| POST | /api/v1/admin/marketing/_index | MarketingController@store | 新增营销管理总览 | marketing:create |
| GET | /api/v1/admin/marketing/_index/{id} | MarketingController@show | 营销管理总览详情 | marketing:view |
| PUT | /api/v1/admin/marketing/_index/{id} | MarketingController@update | 编辑营销管理总览 | marketing:edit |
| DELETE | /api/v1/admin/marketing/_index/{id} | MarketingController@destroy | 删除营销管理总览 | marketing:delete |
...
| 更新时间 | marketing.updated_at | 直接读取 | 实时 |
