...
| 方法 | 路径 | 控制器方法 | 说明 | 权限标识 |
|------|------|-----------|------|----------|
| GET | /api/v1/admin/marketing/coupon | MarketingController@index | 优惠券列表 | marketing:list |
| POST | /api/v1/admin/marketing/coupon | MarketingController@store | 新增优惠券 | marketing:create |
| GET | /api/v1/admin/marketing/coupon/{id} | MarketingController@show | 优惠券详情 | marketing:view |
| PUT | /api/v1/admin/marketing/coupon/{id} | MarketingController@update | 编辑优惠券 | marketing:edit |
| DELETE | /api/v1/admin/marketing/coupon/{id} | MarketingController@destroy | 删除优惠券 | marketing:delete |
