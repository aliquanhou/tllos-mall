...
| 方法 | 路径 | 控制器方法 | 说明 | 权限标识 |
|------|------|-----------|------|----------|
| GET | /api/v1/admin/marketing/group | MarketingController@index | 拼团活动列表 | marketing:list |
| POST | /api/v1/admin/marketing/group | MarketingController@store | 新增拼团活动 | marketing:create |
| GET | /api/v1/admin/marketing/group/{id} | MarketingController@show | 拼团活动详情 | marketing:view |
| PUT | /api/v1/admin/marketing/group/{id} | MarketingController@update | 编辑拼团活动 | marketing:edit |
| DELETE | /api/v1/admin/marketing/group/{id} | MarketingController@destroy | 删除拼团活动 | marketing:delete |
