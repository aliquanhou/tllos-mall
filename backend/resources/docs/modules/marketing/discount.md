...
| 方法 | 路径 | 控制器方法 | 说明 | 权限标识 |
|------|------|-----------|------|----------|
| GET | /api/v1/admin/marketing/discount | MarketingController@index | 会员折扣列表 | marketing:list |
| POST | /api/v1/admin/marketing/discount | MarketingController@store | 新增会员折扣 | marketing:create |
| GET | /api/v1/admin/marketing/discount/{id} | MarketingController@show | 会员折扣详情 | marketing:view |
| PUT | /api/v1/admin/marketing/discount/{id} | MarketingController@update | 编辑会员折扣 | marketing:edit |
| DELETE | /api/v1/admin/marketing/discount/{id} | MarketingController@destroy | 删除会员折扣 | marketing:delete |
