...
| 方法 | 路径 | 控制器方法 | 说明 | 权限标识 |
|------|------|-----------|------|----------|
| GET | /api/v1/admin/order/_index | OrderController@index | 订单管理总览列表 | order:list |
| POST | /api/v1/admin/order/_index | OrderController@store | 新增订单管理总览 | order:create |
| GET | /api/v1/admin/order/_index/{id} | OrderController@show | 订单管理总览详情 | order:view |
| PUT | /api/v1/admin/order/_index/{id} | OrderController@update | 编辑订单管理总览 | order:edit |
| DELETE | /api/v1/admin/order/_index/{id} | OrderController@destroy | 删除订单管理总览 | order:delete |
