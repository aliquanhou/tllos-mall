...
| 方法 | 路径 | 控制器方法 | 说明 | 权限标识 |
|------|------|-----------|------|----------|
| GET | /api/v1/admin/merchant/_index | MerchantController@index | 商家管理总览列表 | merchant:list |
| POST | /api/v1/admin/merchant/_index | MerchantController@store | 新增商家管理总览 | merchant:create |
| GET | /api/v1/admin/merchant/_index/{id} | MerchantController@show | 商家管理总览详情 | merchant:view |
| PUT | /api/v1/admin/merchant/_index/{id} | MerchantController@update | 编辑商家管理总览 | merchant:edit |
| DELETE | /api/v1/admin/merchant/_index/{id} | MerchantController@destroy | 删除商家管理总览 | merchant:delete |
