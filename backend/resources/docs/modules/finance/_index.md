...
| 方法 | 路径 | 控制器方法 | 说明 | 权限标识 |
|------|------|-----------|------|----------|
| GET | /api/v1/admin/finance/_index | FinanceController@index | 财务管理总览列表 | finance:list |
| POST | /api/v1/admin/finance/_index | FinanceController@store | 新增财务管理总览 | finance:create |
| GET | /api/v1/admin/finance/_index/{id} | FinanceController@show | 财务管理总览详情 | finance:view |
| PUT | /api/v1/admin/finance/_index/{id} | FinanceController@update | 编辑财务管理总览 | finance:edit |
| DELETE | /api/v1/admin/finance/_index/{id} | FinanceController@destroy | 删除财务管理总览 | finance:delete |
